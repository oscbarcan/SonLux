      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="https://flowbite.com" class="flex ms-2 md:me-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SonLux</span>
          </a>
        </div>
        <div class="flex items-center mr-6">
            ...
            <div class="px-4 py-3">
                <span class="block text-sm text-gray-900 dark:text-white">{{Auth::user()->name}} {{Auth::user()->surnames}}</span>
                <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">{{Auth::user()->rol}}</span>
            </div>
          </div>
      </div>
    </div>
