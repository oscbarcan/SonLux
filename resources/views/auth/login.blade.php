        ...
        <form action="{{ route('login') }} " method="post">
            ...
            <div class="grid mb-6 md:grid-cols-1">
                ...
                <div class="flex items-start mb-6">
                    ...
                    <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ trans('auth.AcceptTerms') }} <a href="{{ route('policy')}}" class="text-blue-600 hover:underline dark:text-blue-500">{{ trans('auth.TermsAndConditions') }}</a>.</label>
                </div>
                @if(session('error'))
                <div class="mb-6">
