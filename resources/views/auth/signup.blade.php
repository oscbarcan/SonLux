...
@section('content')
    <div class="flex justify-center items-center h-full">
        <form action="{{ route('signup') }} " method="post" class="max-w-md w-full">
            ...
            <div class="mb-6">
                <label for="phone_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero de telefono</label>
            ...
            <div class="flex items-start mb-6">
                ...
                <label class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
            </div>
            ...
            <label class="text-sm font-medium">¿Ya tienes cuenta? <a href="login" class="text-blue-600 hover:underline dark:text-blue-500">Haz clic aquí</a>.</label>
        </form>
    </div>
@endsection
