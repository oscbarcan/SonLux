...
<div class="flex items-center justify-center min-h-full">
    <div class="bg-gray-200 p-8 rounded-lg shadow-lg max-w-4xl w-full">
        <div class="text-center">
            <h2 class="text-3xl font-bold text-gray-800">TU PRESUPUESTO <span class="text-orange-500">DE PANELES SOLARES</span></h2>
            <p class="text-gray-600 mt-2">
                <em>Este presupuesto se ha calculado en base a las características de una <strong>vivienda {{$data['tipo_casa']}} conectada a la red eléctrica</strong>. Los precios que aparecen son válidos en toda la <strong>Comunidad Valenciana</strong></em>
            </p>
        </div>
        <div class="border-t border-gray-300 my-4"></div>
        <div class="flex flex-wrap -mx-4">
            <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0 flex justify-center">
                <img src="/assets/img/house.png" alt="Paneles Solares" class="object-cover w-full h-auto">
            </div>
            <div class="w-full md:w-1/2 px-4 flex items-center">
                <div class="text-center md:text-left">
                    ...
                    <div class="flex space-x-4 justify-between">
                        <a href="{{route('message.create')}}" class="bg-blue-500 text-white py-2 px-4 rounded-md">Contacta con nosotros</a>
                        <a href="{{route('products.index')}}" class="bg-red-500 text-white py-2 px-4 rounded-md">COMPRAR AHORA</a>
                    </div>
                </div>
            </div>
        </div>
