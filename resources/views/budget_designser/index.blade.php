...
@section('title', trans('budget.BudgetDesigner'))
...
@section('content')
    <form action="{{route('form-Results')}}" method="POST" id="formulario">
        ...
        <div class="main-container">
            <div id="div1">
                <div class="text-4xl font-bold">{{trans('budget.FindHouse')}}</div>
                <br>
                <div class="div-num">
                    <div class="container-mapa">
                        <div id="map" class="map"></div>
                    </div>
                    <div class="container-info-mapa p-5">
                        <div class="text-3xl p-5">{{trans('budget.AvailableSurface')}}</div>
                        <div class="p-4">1. {{trans('budget.SelectSurface')}}</div>
                        ...
                        <div class="p-12">2. {{trans('budget.SelectRoofType')}}</div>
                        <div class="tipo-casa">
                            ...
                            <label for="unifamiliar">
                                <div class="card" id="unifamiliar">
                                    <div class="p-3">{{trans('budget.Unifamiliar')}}</div>
                            ...
                            <label for="comunidad">
                                <div class="card" id="comunidad">
                                    <div class="p-3">{{trans('budget.Comunidad')}}</div>
                            ...
                            <label for="empresa">
                                <div class="card" id="empresa">
                                    <div class="p-3">{{trans('budget.Empresa')}}</div>
            ...
            <div id="div2" style="display: none;">
                <div class="text-4xl font-bold text-center">{{trans('budget.SelectPowerCapacity')}}</div>
                    <div class="div-num">
                        <div class="container-general tipo-almacenamiento">
                            ...
                            <label for="con-al">
                                <div class="card" id="con-al">
                                    <div class="p-3">{{trans('budget.WithCapacity')}}</div>
                            ...
                            <label for="sin-al">
                                <div class="card" id="sin-al">
                                    <div class="p-3">{{trans('budget.WithoutCapacity')}}</div>
            ...
            <div id="div3" style="display: none;">
                <div class="text-4xl font-bold text-center">{{trans('about.SelectOrientation')}}</div>
                    <div class="div-num">
                                ...
                                <div class="separador">
                                    ...
                                    <label for="norte">
                                        <div class="card" id="norte">
                                            <div class="p-3">{{trans('budget.NorthOrientation')}}</div>
                                    ...
                                    <label for="sur">
                                        <div class="card" id="sur">
                                            <div class="p-3">{{trans('budget.SouthOrientation')}}</div>
                                ...
                                <div class="separador">
                                    ...
                                    <label for="este">
                                        <div class="card" id="este">
                                            <div class="p-3">{{trans('budget.EastOrientation')}}</div>
                                    ...
                                    <label for="oeste">
                                        <div class="card" id="oeste">
                                            <div class="p-3">{{trans('budget.WestOrientation')}}</div>
            ...
            <div id="div4" style="display: none;">
                    <div class="div-num">
                        <div class="container-general flex flex-col">
                            <div class="text-4xl font-bold text-center">{{trans('budget.PhaseType')}}?</div>
                            <div class="flex flex-row">
                                ...
                                <label for="monofasica" class="min-w-40">
                                    <div class="card" id="card-monofasica">
                                        <div class="p-3">{{trans('budget.Monophase')}}</div>
                                        <svg width="64px" height="64px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M85.333333 192h640l213.333334 320-213.333334 320H85.333333z" fill="#CFD8DC"></path><path d="M725.333333 192h-149.333333l213.333333 320-213.333333 320h149.333333l213.333334-320z" fill="#FF3D00"></path><path d="M426.666667 533.333333h-64v85.333334h85.333333v42.666666h-149.333333V362.666667h149.333333v42.666666h-85.333333v85.333334h64v42.666666z" fill="#455A64"></path></g></svg>
                                    </div>
                                </label>
                                ...
                                <label for="trifasica" class="min-w-40">
                                    <div class="card" id="trifasica">
                                        <div class="p-3">{{trans('budget.ThreePhase')}}</div>
                                        <svg width="64px" height="64px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M938.666667 832H298.666667L85.333333 512 298.666667 192h640z" fill="#CFD8DC"></path><path d="M536.704 661.333333l-49.770667-298.666666h61.226667l15.338667 118.037333c3.818667 33.088 7.658667 66.325333 11.456 103.146667 3.882667-36.821333 11.541333-70.058667 19.2-103.146667L617.130667 362.666667h49.792l19.136 118.037333c3.776 33.088 11.434667 66.325333 15.317333 106.88 3.797333-40.533333 7.658667-70.058667 11.456-106.88L728.170667 362.666667h57.429333l-53.610667 298.666666h-61.290666l-19.114667-99.498666c-7.616-25.834667-11.541333-59.072-15.296-95.872-3.925333 36.821333-11.541333 70.037333-15.36 99.456L601.834667 661.333333h-65.130667z" fill="#455A64"></path><path d="M448 192h-149.333333L85.333333 512l213.333334 320h149.333333L234.666667 512z" fill="#FF3D00"></path></g></svg>
                                    </div>
                                </label>
                            </div>

                            <div class="text-4xl font-bold text-center">{{trans('budget.SelectCarCharger')}}?</div>
                            <div class="flex flex-row">
                                ...
                                <label for="con-cargador" class="min-w-40">
                                    <div class="card" id="con-cargador">
                                        <div>{{trans('budget.WithCarCharger')}}</div>
                                    </div>
                                </label>
                                ...
                                <label for="sin-cargador" class="min-w-40">
                                    <div class="card" id="sin-cargador">
                                        <div>{{trans('budget.WithoutCarCharger')}}</div>
                                    </div>
                                </label>
                            </div>
                        </div>
            ...
            <div class="container-botones mt-5">
                <button type="button" id="atras" disabled class="boton-desactivado focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">{{trans('budget.Back')}}</button>
                <button type="button" id="continuar" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">{{trans('budget.Next')}}</button>
                <button type="submit" id="enviar" style="display: none;" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">{{trans('budget.Send')}}</button>
            </div>
        </div>
    </form>
